package me.limeglass.khoryl.elements.item.shield;
...
@Since("1.0.4")
public class ExprShieldBanner extends ItemMetaExpression<BundleMeta, ItemStack> {

	static {
		register(ExprShieldBanner.class, ItemStack.class, "bundle item[s]");
	}
