...
@Name("Bee Stung")
@Description("Gets if the bee(s) has stung. Can be set.")
@Since("1.0.2")
public class ExprBeeStung extends EntityPropertyExpression<LivingEntity, Bee, Boolean> {

	static {
		if (!Skript.getMinecraftVersion().isSmallerThan(new Version(1, 15)))
			register(ExprBeeStung.class, Boolean.class, "[(has|have)] stung", "livingentities");
	}
