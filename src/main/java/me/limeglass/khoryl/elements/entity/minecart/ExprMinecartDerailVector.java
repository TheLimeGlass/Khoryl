...
@Name("Minecart Derail Velocity")
@Description("The velocity at which the minecart derails at.")
@Since("1.1.0")
public class ExprMinecartDerailVector extends EntityPropertyExpression<Entity, Minecart, Vector> {

	static {
		register(ExprMinecartDerailVector.class, Vector.class, "[minecart] derail ve(ctor|locity) [mod]");
	}
